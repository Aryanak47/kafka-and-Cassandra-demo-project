...
//        User b1 = new User("1491950358", "Building Microservices");
//        User b2 = new User("1680502395", "Release It!");
//
...
//    }
//
//    private BookAnalytics findBookAnalytics(User b, List<BookAnalytics> analytics) {
//        return analytics
//                .stream()
